...
(unless *emacs/>=27p*  (push '(menu-bar-lines . 0) default-frame-alist)
...
(use-package all-the-icons
  :if *sys/gui*  :init (unless (or *sys/win32p* (font-installed-p "all-the-icons"))                           (all-the-icons-install-fonts t))
  :config
  (with-no-warnings
