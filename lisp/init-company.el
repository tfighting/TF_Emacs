...
(use-package company
  ...
  (setq company-tooltip-align-annotations t
        ...
        company-echo-delay (if *sys/gui* nil 0)        company-minimum-prefix-length 2
...
;; Icons and quickhelp
(when *emacs/>=26p*  (use-package company-box
                       :diminish
                       :hook (company-mode . company-box-mode)
                       :init (setq company-box-backends-colors nil
                                   company-box-show-single-candidate t
                                   company-box-max-candidates 5000
                       ...
                       (when (and *sys/gui*               (require 'all-the-icons nil t))
