...
(when t_fighting-chinese-calendar
    ...
    (unless (ignore-errors
              (cfw:open-calendar-buffer
               ...
               (list
                ...
                (when (bound-and-true-p t_fighting-ical)
                  (cfw:ical-create-source "gcal" t_fighting-ical "IndianRed")))))
      (cfw:open-calendar-buffer)))
  (defalias 't_fighting-open-calendar 'open-calendar))
