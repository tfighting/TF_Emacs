...
(use-package youdao-dictionary
  ...
  (with-no-warnings
    (defun my-youdao-search-at-point ()
      ...
      (interactive)
      (if *sys/gui*          (if *emacs/>=26p*                                   (youdao-dictionary-search-at-point-posframe)
...
;; PDF reader
(when *sys/gui*  (use-package pdf-view
                     :ensure pdf-tools
                     ...
                     (when *sys/mac*                       (setenv "PKG_CONFIG_PATH"
                     ...
                     (when *emacs/>=26p*                       (use-package pdf-view-restore
